...
Version: Hurricane (0.6.2) 2010/06/30
...
* install MongoDB (at least 1.4.0)[2]
...
p. With MongoDoc, instead of saving JSON[3], we can save an object directly:
...
fn2. If you are using @MongoDB@ 1.5, you need to use @mongo >= 1.0.2@.

fn3. The Ruby driver exposes an API that understands JSON.
